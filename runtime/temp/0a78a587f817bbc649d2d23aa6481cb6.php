<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wokerplace\gongxin.com\public/../app/admin\view\article\add.html";i:1535456585;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/Article/save'); ?>">
                            ...
                            <div class="panel-body">
                                ...
                                <tr>
                                   ...
                                   <select name="cid" class='form-control valid'>
                                        ...
                                        <option value="<?php echo $vo['id']; ?>" <?php if($vo['child'] == 1): ?>disabled<?php endif; ?>><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo $vo['name']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </td>
                                </tr>
                                    ...
                                    <!-- <tr>
                                        <td id="box">小标题</td>
                                        <td >
                                            <input type="text" name="title1" value="" required  lay-verify="required" placeholder="小标题" class="form-control">
                                        </td>
                                    </tr> -->
