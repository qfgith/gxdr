<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\wokerplace\gongxin.com\public/../app/home\view\team.html";i:1535528531;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\header.html";i:1535540029;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\catpos.html";i:1535534796;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\footer.html";i:1535538215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="service">
            <header>
                <div class="container">
                    ...
                    <ul class="menu">
                        <li><a href="<?php echo url('/team'); ?>"><?php echo $categorynavs[$base_id]['name']; ?></a></li>
                    </ul>
                </div>
            </header>
            <div class="team_body">
                ...
                <div class="team_content">
                    <div class="container">
                        <div class="team_introduce">
                            <h2>拥有丰富行业经验的资深专业团队</h2>
                            <p><?php echo $categorynavs[$base_id]['content']; ?></p>
                        </div>
                    </div>
                    <div class="evaluation_team">
                        <div class="container">
                            <h2><img src="__GX__\asset\images\icon_team.png" alt=""> 评估团队</h2>
                        </div>
                        <ul class="team_list">
                            ...
                            <li class="team_item">
                                <div class="container">
                                    <div class="row">
                                        <?php if(is_array($v['pseron1']) || $v['pseron1'] instanceof \think\Collection): $i = 0; $__LIST__ = $v['pseron1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                        <div class="col-lg-6">
                                            <p><?php echo $vv['title']; ?></p>
                                            <p><?php echo $vv['title1']; ?></p>
                                            <p><?php echo $vv['title2']; ?></p>
                                            <img src="__GX__\asset\images\icon_plus.svg" width="30" class="icon_plus">
                                        </div>
...
<script src="__GX__\lib\jquery-3.3.1\jquery.min.js"></script>
<script src="__GX__\asset\js\team.js"></script>
