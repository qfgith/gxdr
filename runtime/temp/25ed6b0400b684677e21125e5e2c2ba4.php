<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wokerplace\gongxin.com\public/../app/admin\view\team\edit.html";i:1535535965;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/Team/update'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td >
                                             <select name="cid" lay-verify="required" class='col-sm-4 form-control select2'>
                                                ...
                                                <option <?php if($vo['id'] == $article['cid']): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>" <?php if($vo['child'] == 1): ?>disabled="disabled"<?php endif; ?> ><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo $vo['name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                    ...
                                    <tr>
                                        <td id="box">标题</td>
                                        <td >
                                            <input type="text" name="title" value="<?php echo $article['title']; ?>" required  lay-verify="required" placeholder="标题" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">英文名</td>
                                        <td >
                                            <input type="text" name="title1" value="<?php echo $article['title1']; ?>" required  lay-verify="required" placeholder="英文名" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">职位</td>
                                        <td >
                                            <input type="text" name="title2" value="<?php echo $article['title2']; ?>" required  lay-verify="required" placeholder="职位" class="form-control">
                                        </td>
                                    </tr>
                                     <tr>
                                        <td id="box">邮箱</td>
                                        <td >
                                            <input type="text" name="email" value="<?php echo $article['email']; ?>" required  lay-verify="required" placeholder="邮箱" class="form-control">
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                        <td id="box"> 略缩图 </td>
                                        <td >
                                            <input type="text" name="thumb" id="img" size="50" value="<?php echo $article['thumb']; ?>" class="layui-input input-text">
                                            <button type="button" class="btn btn-primary layui_upimage">上传图片</button>
                                            <?php if(!(empty($article['thumb']) || ($article['thumb'] instanceof \think\Collection && $article['thumb']->isEmpty()))): ?><img src="/<?php echo $article['thumb']; ?>" class="th1_img imgb"><?php endif; ?>
                                        </td>
                                    </tr> -->
                                    ...
                                    <tr>
                                        <td id="box">介绍</td>
                                        <td >
                                            <textarea class="form-control" name="content" rows="10"><?php echo $article['content']; ?></textarea>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="box"> 状态 </td>
                                        <td >
                                            <input type="radio" class='iccontrol' name="status" value="1" title="已审核" <?php if($article['status'] == 1): ?>checked="checked"<?php endif; ?>><span class="ml10 mr30">已审核</span>
                                            <input type="radio" class='iccontrol' name="status" value="0" title="未审核" <?php if($article['status'] == 0): ?>checked="checked"<?php endif; ?>><span class="ml10 mr30">未审核</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="box"> 推荐到首页 </td>
                                        <td >
                                            <input type="radio" class='iccontrol' name="is_pos" value="0" title="否" <?php if($article['is_pos'] == 0): ?>checked="checked"<?php endif; ?>><span class="ml10 mr30">否</span>
                                            <input type="radio" class='iccontrol' name="is_pos" value="1" title="是" <?php if($article['is_pos'] == 1): ?>checked="checked"<?php endif; ?>><span class="ml10 mr30">是</span>
                                        </td>
                                    </tr>
