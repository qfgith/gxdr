<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wokerplace\gongxin.com\public/../app/admin\view\feedback\index.html";i:1534329898;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $title; ?>列表</h3>
                </div>
                <!-- search -->
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <?php if(is_array($feedback_list) || $feedback_list instanceof \think\Collection): $i = 0; $__LIST__ = $feedback_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    
                                    <td><?php echo $vo['id']; ?></td>
                                    <td><a href='<?php echo url("Admin/Feedback/edit",["id"=>$vo["id"]]); ?>'><?php echo $vo['type']; ?></a></td>
                                    ...
                                    <td>
                                        <a href='<?php echo url("Admin/Feedback/edit",["id"=>$vo["id"]]); ?>' class="btn btn-xs btn-primary">编辑</a>
                                        <a href='<?php echo url("Admin/Feedback/delete",["id"=>$vo["id"]]); ?>' onclick="return confirm('确定删除吗?')" lay-filter="*" class="btn btn-xs btn-danger">删除</a>
                                    </td>
