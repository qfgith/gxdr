<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\wokerplace\gongxin.com\public/../app/admin\view\page_contact_category\edit_page.html";i:1535429639;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/PageServiceCategory/update_page'); ?>">
