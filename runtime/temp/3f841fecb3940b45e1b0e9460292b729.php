<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wokerplace\gongxin.com\public/../app/admin\view\cases\edit.html";i:1535530689;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/Cases/update'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                             <select name="cid" lay-verify="required" class='col-sm-4 form-control select2'>
                                                ...
                                                <option value="<?php echo $vo['id']; ?>"<?php if($vo['id'] == $article['cid']): ?>selected<?php endif; if($vo['child'] == 1): ?>disabled="disabled"<?php endif; ?> ><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo $vo['name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
