<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"admin_themes/auth_group\edit.html";i:1533016246;s:22:"admin_themes/base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info info_box">
                ...
                <div class="box-body">
                    <!--表单数据-->
                    <form method="post" id="roleform" action="<?php echo url('admin/auth_group/update'); ?>" onsubmit="return roleSubmit()">
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>状态：</td>
                                    <td>
                                        <input type="radio" name="status" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?> ><span class="ml10 mr30">启用</span>
                                        <input type="radio" name="status" value="0" <?php if($info['status'] == 0): ?>checked<?php endif; ?> ><span class="ml10 mr30">禁用</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>权限分配：</b></td>
                                ...
                                <?php if(is_array($modules) || $modules instanceof \think\Collection): if( count($modules)==0 ) : echo "" ;else: foreach($modules as $kk=>$menu): ?>           
                                    <tr>
                                        <td class="title left" style="padding-right:50px;">
                                            <b><?php echo $agroup[$kk]; ?>：</b>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="group-list">
                                            <?php if(is_array($menu) || $menu instanceof \think\Collection): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $key=>$vv): ?>
                                                <li><input type="checkbox" name="right[]" value="<?php echo $vv['id']; ?>" <?php if($vv['enable'] == 1): ?>checked<?php endif; ?> ck="mod-<?php echo $kk; ?>"><?php if($vv['level'] != '1'): ?>|<?php for($i=1;$i<$vv['level'];$i++){echo ' ----';} endif; ?><label><?php echo $vv['title']; ?></label></li>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
