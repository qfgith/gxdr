<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\wokerplace\gongxin.com\public/../app/admin\view\page_contact_category\index.html";i:1535506433;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <form class="navbar-form form-inline" method="post" action="">
                            ...
                            <if condition="$moduleid neq 3"><a href='<?php echo url("admin/page_contact_category/add"); ?>' class="btn btn-info pull-right">添加栏目</a></if>
                        </form>
                    </div>
                </div>
                <!-- table -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action='<?php echo url("Admin/page_contact_category/listorder"); ?>' method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($vo['pid'] == 0): ?><a href="<?php echo url('admin/page_contact_category/add',['pid'=>$vo['id']]); ?>" class="btn btn-warning">添加子栏目</a><?php endif; ?>
                                        <a href="<?php echo url('admin/page_contact_category/edit',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑</a>
                                        <a href="<?php echo url('admin/page_contact_category/delete',['id'=>$vo['id']]); ?>" onclick="return delfun(this)" class="btn btn-danger btn-mini">删除</a>
                                    </td>
                                    <td><a href="<?php echo url('admin/PageContactCategory/edit_page',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑内容</a></td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
