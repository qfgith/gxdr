<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\wokerplace\gongxin.com\public/../app/home\view\cases.html";i:1535530300;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\header.html";i:1535540029;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\catpos.html";i:1535534796;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\footer.html";i:1535538215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<?php endif; ?>
                    ...
                    <div class="case_content">
                        <ul class="case_list">
                            ...
                            <li class="case_item">
                                <div class="title">
                                    <img src="__GX__\asset\images\icon_plus2.svg" width="21" class="pull-right"> <?php echo $v['name']; ?>
                                </div>
                                <div class="content">
                                    <table class="case_table">
                                        ...
                                        <tbody>
                                            <?php if(is_array($v['list']) || $v['list'] instanceof \think\Collection): $i = 0; $__LIST__ = $v['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td><a href="<?php echo url('/casesshow',['id'=>$vv['id']]); ?>" title="<?php echo $vv['title1']; ?>"><p><?php echo $vv['title1']; ?></p></a></td>
                                                <td><a href="<?php echo url('/casesshow',['id'=>$vv['id']]); ?>" title="<?php echo $vv['title']; ?>"><p><?php echo $vv['title']; ?></p></a></td>
                                                <td><a href="<?php echo url('/casesshow',['id'=>$vv['id']]); ?>" title="<?php echo $vv['introduction']; ?>"><p><?php echo str_cut($vv['introduction'],70); ?></p></a></td>
                                            </tr>
...
<script src="__GX__\lib\jquery-3.3.1\jquery.min.js"></script>
<script src="__GX__\asset\js\case.js"></script>