<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wokerplace\gongxin.com\public/../app/admin\view\case_category\edit.html";i:1535451788;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/case_category/update'); ?>">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td id="box"> 栏目介绍 </td>
                                        <td >
                                            <textarea class="form-control" name="content" rows="3"><?php echo $category['content']; ?></textarea>
                                        </td>
                                    </tr>
