<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wokerplace\gongxin.com\public/../app/admin\view\category\edit.html";i:1534321174;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/category/update'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td id="box">别名</td>
                                        <td >
                                            <input type="text" name="alias" value="<?php echo $category['alias']; ?>" placeholder="（选填）请输入栏目别名" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box"> 略缩图 </td>
                                        <td >
                                            <input type="text" name="thumb" value="<?php echo $category['thumb']; ?>" id="img" size="50" class="layui-input input-text">
                                            <button type="button" class="btn btn-primary layui_upimage">上传图片</button>
                                            <img src="<?php echo $category['thumb']; ?>" class="th1_img imgh">
                                        </td>
                                    </tr>
