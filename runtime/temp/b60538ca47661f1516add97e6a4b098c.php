<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"admin_themes/article\edit.html";i:1535456600;s:22:"admin_themes/base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/Article/update'); ?>">
                            ...
                            <div class="panel-body">
                                ...
                                <tr>
                                   ...
                                   <select name="cid" class='form-control valid'>
                                        ...
                                        <option <?php if($vo['id'] == $article['cid']): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>" <?php if($vo['child'] == 1): ?>disabled<?php endif; ?>><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo $vo['name']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </td>
                                </tr>
                                    ...
                                    <!-- <tr>
                                        <td id="box">小标题</td>
                                        <td >
                                            <input type="text" name="title1" value="<?php echo $article['title1']; ?>" required  lay-verify="required" placeholder="小标题" class="form-control">
                                        </td>
                                    </tr> -->
                                    ...
                                    <tr>
                                        <td id="box"> 略缩图 </td>
                                        <td >
                                            <input type="text" name="thumb" value="<?php echo $article['thumb']; ?>" id="img" size="50" class="layui-input input-text">
                                   ...
                                   <!--  <tr>
                                    ...
                                    <tr>
                                        <td id="box">发布人</td>
                                        <td >
                                            <input type="text" name="author" value="<?php echo $article['author']; ?>" required  lay-verify="required" placeholder="发布人" class="form-control">
                                        </td>
                                    </tr>
