<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"admin_themes/auth_group\add.html";i:1535616378;s:22:"admin_themes/base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info info_box">
                ...
                <div class="box-body">
                    <!--表单数据-->
                    <form method="post" id="roleform" action="<?php echo url('admin/auth_group/save'); ?>" onsubmit="return roleSubmit()">
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>状态：</td>
                                    <td>
                                        <input type="radio" name="status" value="1" checked ><span class="ml10 mr30">启用</span>
                                        <input type="radio" name="status" value="0" ><span class="ml10 mr30">禁用</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>权限分配：</b></td>
                                ...
                                <tr>
                                    <td></td>
                                    <td class="text-right"><!-- lay-submit lay-filter="*"-->
