<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\wokerplace\gongxin.com\public/../app/home\view\news_detail.html";i:1535534007;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\header.html";i:1535540029;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\catpos.html";i:1535534796;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\footer.html";i:1535538215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body <?php if(isset($ishome)): ?>id="page_index"<?php endif; ?>>
    ...
    <main>
        <?php if(empty($categorynavs[$cate_id]['thumb']) || ($categorynavs[$cate_id]['thumb'] instanceof \think\Collection && $categorynavs[$cate_id]['thumb']->isEmpty())): ?>    
        <img src="/<?php echo $categorynavs[$base_id]['thumb']; ?>" alt="" class="img-responsive" width="100%">
        <?php else: ?>
        <img src="/<?php echo $categorynavs[$cate_id]['thumb']; ?>" alt="" class="img-responsive" width="100%">
        <?php endif; ?>
                ...
                <div class="container">
                    <div class="menu_card">
                       <img src="__GX__\asset\images\icon_right.png" class="img-responsive pull-right">
                        <h1><?php echo $categorynavs[$base_id]['name']; ?></h1>
                        <div class="line"></div>
                        <p><?php echo $categorynavs[$base_id]['alias']; ?></p>
                    </div>
                    <ul class="menu">
                        ...
                        <li <?php if($cate_id == $v['id']): ?>class="active"<?php endif; ?> ><a href="<?php echo url('/news',['cid'=>$v['id']]); ?>"><?php echo $v['name']; ?></a></li>
...
<?php endif; ?>
                    ...
                    <article class="news_detail_content">
                        <header>
                            <h2><?php echo $info['title']; ?></h2>
                            <img src="__GX__\asset\images\icon_time.jpg"><time> 发布时间：<?php echo date("Y-m-d",$info['create_time']); ?></time>
                            <img src="__GX__\asset\images\icon_author.jpg"><span> 发布人：<?php echo $info['author']; ?></span>
                        </header>
                        ...
                        <footer>
                            <nav>
                                <ul class="pager">
                                    <li class="previous"><a href="<?php if(!(empty($prev_article) || ($prev_article instanceof \think\Collection && $prev_article->isEmpty()))): ?><?php echo url('/newsshow',['cid'=>$cate_id,'id'=>$prev_article['id']]); else: ?>###<?php endif; ?>"><span aria-hidden="true">&lt;</span>&nbsp;&nbsp;上一篇</a></li>
                                    <li class="text-center"><a href="<?php echo url('/news'); ?>"><span class="glyphicon glyphicon-menu-hamburger"></span></a></li>
                                    <li class="next"><a href="<?php if(!(empty($next_article) || ($next_article instanceof \think\Collection && $next_article->isEmpty()))): ?><?php echo url('/newsshow',['cid'=>$cate_id,'id'=>$next_article['id']]); else: ?>###<?php endif; ?>">下一篇&nbsp;&nbsp;<span aria-hidden="true">&gt;</span></a></li>
                                </ul>
                            </nav>
                        </footer>
                    </article>
