<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wokerplace\gongxin.com\public/../app/admin\view\feedback\edit.html";i:1535535783;s:60:"D:\wokerplace\gongxin.com\public/../app/admin\view\base.html";i:1535455166;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/feedback/update'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <td id="box">类型</td>
                                        <td >
                                            <input type="text" name="type" disabled="disabled" value="<?php echo $info['type']; ?>" required  lay-verify="required" placeholder="类型" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">姓名</td>
                                        <td >
                                            <input type="text" name="uname" value="<?php echo $info['uname']; ?>" required  lay-verify="required" placeholder="姓名" class="form-control">
                                        </td>
                                    </tr>
                                     <tr>
                                        <td id="box">手机</td>
                                        <td >
                                            <input type="text" name="mobile" value="<?php echo $info['mobile']; ?>" required  lay-verify="required" placeholder="手机" class="form-control">
                                        </td>
                                    </tr>
                                    <!--  <tr>
                                        <td id="box">邮箱</td>
                                        <td >
                                            <input type="text" name="email" value="<?php echo $info['email']; ?>" required  lay-verify="required" placeholder="邮箱" class="form-control">
                                        </td>
                                    </tr> -->
                                    <tr>
                                        <td id="box">内容</td>
