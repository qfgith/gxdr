<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\wokerplace\gongxin.com\public/../app/home\view\cases_detail.html";i:1535531130;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\header.html";i:1535540029;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\catpos.html";i:1535534796;s:61:"D:\wokerplace\gongxin.com\public/../app/home\view\footer.html";i:1535538215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body <?php if(isset($ishome)): ?>id="page_index"<?php endif; ?>>
    ...
    <main>
        <img src="/<?php echo $pagenavs['thumb']; ?>" alt="" class="img-responsive" width="100%">
        <section class="news_detail">
            <header>
                <div class="container">
                    ...
                    <ul class="menu">
                        <li><a href="<?php echo url('/cases'); ?>"><?php echo $categorynavs[$base_id]['name']; ?></a></li>
                    </ul>
                </div>
            </header>
...
<?php endif; ?>
                    ...
                    <article class="news_detail_content">
                        ...
                        <footer>
                            <nav>
                                <ul class="pager">
                                    <li class="previous"><a href="<?php if(!(empty($prev_article) || ($prev_article instanceof \think\Collection && $prev_article->isEmpty()))): ?><?php echo url('/casesshow',['id'=>$prev_article['id']]); else: ?>###<?php endif; ?>"><span aria-hidden="true">&lt;</span>&nbsp;&nbsp;上一篇</a></li>
                                    <li class="text-center"><a href="<?php echo url('/cases'); ?>"><span class="glyphicon glyphicon-menu-hamburger"></span></a></li>
                                    <li class="next"><a href="<?php if(!(empty($next_article) || ($next_article instanceof \think\Collection && $next_article->isEmpty()))): ?><?php echo url('/casesshow',['id'=>$next_article['id']]); else: ?>###<?php endif; ?>">下一篇&nbsp;&nbsp;<span aria-hidden="true">&gt;</span></a></li>
                                </ul>
                            </nav>
                        </footer>
                    </article>
